...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/asset/**").hasAnyAuthority("ADMIN","ASSET_ADMIN")
                .antMatchers("/hr/**").hasAnyAuthority("ADMIN","HR_ADMIN")
                .antMatchers("/accounts/**").hasAnyAuthority("ADMIN","ACCOUNTS_ADMIN")
