...
public class EmployeeService {
   ...
   // Get total number of employees
    ...
    // Check if existing using security number
	public boolean isSocialSecurityNumber(String socialSecurityNumber) {
		return employeeRepository.findBySocialSecurityNumber(socialSecurityNumber) != null;
	}
